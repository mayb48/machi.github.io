...
$(function () {
    // setup garden
	$Machi = $("#Machi");
	var offsetX = $Machi.width() / 2;
	var offsetY = $Machi.height() / 2 - 55;
    $garden = $("#garden");
    gardenCanvas = $garden[0];
	gardenCanvas.width = $("#Machi").width();
    gardenCanvas.height = $("#Machi").height()
    gardenCtx = gardenCanvas.getContext("2d");
    gardenCtx.globalCompositeOperation = "lighter";
    garden = new Garden(gardenCtx, gardenCanvas);
	
	$("#content").css("width", $Machi.width() + $("#code").width());
	$("#content").css("height", Math.max($Machi.height(), $("#code").height()));
